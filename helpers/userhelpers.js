...
const ffmpegPath = require('ffmpeg-static'); // Import the path to the FFmpeg binary
        ...
        return new Promise (async(resolve ,reject)=>
            {   
                try {
                    ...
                    const caption = '⚠️ Attention: This content has been generated by artificial intelligence. While we strive for accuracy, please be aware that AI-generated content may contain errors or omissions. Always verify the information presented and use it responsibly. Cross-check facts with reliable sources and consult experts when necessary. Your discretion is advised. ⚠️                                                                                    #bodybuildingmotivation #chanakyamotivation #chanakyaneeti #fitness #life #motivation #lifestyle #gym #workout #fit #fitfam #luxury #quotes #quote #motivationalquotes #luxurylifestyle #motivational #luxuryhomes #mondaymotivation #luxurylife #luxurybrands #motivational_quotes #motivationalsayings #luxurygifts #motivationssprüche #keepitup #motivation💪 #luxuryvacation #luxuryvillas #motivationmondays';
...
uploadToTransferSh : () => {
  ...
  uploadToFacebook:(url)=>
  {
    return new Promise(async(resolve,reject)=>
    {
        const pageId = '436425726218110';
        const accessToken = process.env.FACEBOOK_ACCESS_TOKEN;
        const videoUrl = url;
        const description = '⚠️ Attention: This content has been generated by artificial intelligence. While we strive for accuracy, please be aware that AI-generated content may contain errors or omissions. Always verify the information presented and use it responsibly. Cross-check facts with reliable sources and consult experts when necessary. Your discretion is advised. ⚠️                                                                                    #bodybuildingmotivation #chanakyamotivation #chanakyaneeti #fitness #life #motivation #lifestyle #gym #workout #fit #fitfam #luxury #quotes #quote #motivationalquotes #luxurylifestyle #motivational #luxuryhomes #mondaymotivation #luxurylife #luxurybrands #motivational_quotes #motivationalsayings #luxurygifts #motivationssprüche #keepitup #motivation💪 #luxuryvacation #luxuryvillas #motivationmondays';
        ...
        try {
            ...
            // Optional: Step 2 - Check the status of the video upload
